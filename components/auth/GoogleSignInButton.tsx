    ...
    <>
      ...
      {hint ? (
        <button
          ...
          className="w-full flex items-center justify-center gap-3 h-12 rounded-full bg-primary text-primary-foreground font-semibold text-sm transition-opacity hover:opacity-90"
        >
          <GoogleIcon />
